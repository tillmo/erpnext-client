...
#        company.Company.current_load_data()    
    ...
    # for experiments and debugging    
        ...
        print(gui_api_wrapper(Api.api.get_list,'Bank Transaction',filters = {'date': '2021-04-20', 'bank_account': 'S%C3%96%20Allgemeinbildung%20-%20Sparkasse%20Bremen', 'description': 'Spenden VA-Reihe Allgemeinbildung - Natur Mensch Technik e.V.', 'currency': 'EUR', 'debit': 0, 'credit': 330.0, 'status': ['!=', 'Cancelled']}))
