...
class TestJournalEntry:
    def test_journal_entry_draft(self, live, api, cleanup, today):
        ref = tag("JE")
    ...
    def test_journal_entry3_draft(self, live, api, cleanup, today):
    ...
    def test_delete_entry_removes_journal_entry(self, live, api, today, capsys):
...
class TestPaymentEntry:
    def test_create_payment_draft(self, live, api, cleanup, test_supplier, today):
        ref = tag("PAY")
    ...
    def test_receive_payment_draft(self, live, api, cleanup, today):
    ...
    def test_delete_entry_for_payment(self, live, api, test_supplier, today):
