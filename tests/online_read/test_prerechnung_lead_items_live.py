...
class TestPreRechnung:
    ...
    def test_pre_invoice_pdfs_are_downloadable(self, api, live):
...
class TestLeads:
    ...
    def test_unassigned_filter_is_accepted(self, api):
...
class TestItems:
    def test_load_item_data(self, live, api, capsys):
        Api.items_by_code = {}
    ...
    def test_load_account_data(self, live):
    ...
    def test_default_items_are_enabled(self, api):
        import settings
