...
class TestConnection:
    ...
    def test_read_only_guard(self, api: Any) -> None:
...
class TestGetListSemantics:
    ...
    def test_requested_fields_only(self, api: Any, live: LiveState) -> None:
    ...
    def test_default_page_length_is_20(self, api: Any) -> None:
    ...
    def test_limit_and_order(self, api: Any) -> None:
    ...
    def test_filters_operators(self, api: Any, live: LiveState) -> None:
    ...
    def test_child_table_join(self, api: Any, live: LiveState) -> None:
...
class TestDocuments:
    def test_get_doc_company(self, api: Any, live: LiveState) -> None:
    ...
    def test_get_doc_missing_raises(self, api: Any) -> None:
        with pytest.raises(FrappeException):
            api.get_doc("Company", "gibt es ganz sicher nicht")

    def test_get_doc_quoted_name(self, api: Any, live: LiveState) -> None:
        import urllib.parse
...
class TestReports:
    ...
    def test_profit_and_loss_report(self, api: Any, live: LiveState) -> None:
        year = __import__("datetime").date.today().year
    ...
    def test_consolidated_statement_is_synchronous(self, api: Any, live: LiveState) -> None:
        year = __import__("datetime").date.today().year
        filters = {"company": live.company_name, "period_start_date": "{}-01-01".format(year),
...
class TestFiles:
    def test_get_file_of_purchase_invoice(self, api: Any, live: LiveState) -> None:
    ...
    def test_get_pdf_of_sales_invoice(self, api: Any, live: LiveState) -> None:
